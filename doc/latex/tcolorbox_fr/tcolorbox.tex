...
\ShellEscape{mkdir -p external}   % to avoid warning message on linux system
\ShellEscape{mkdir -p solutions}
...
% to work on each part individualy !
...
%\includeonly{tcolorbox.doc.verbatim}
%\includeonly{tcolorbox.doc.recording}
%\includeonly{tcolorbox.doc.technical}
%\includeonly{tcolorbox.doc.skins}
%\includeonly{tcolorbox.doc.graphics}
%\includeonly{tcolorbox.doc.filling}
%\includeonly{tcolorbox.doc.vignette}
%\includeonly{tcolorbox.doc.raster}
...
%\includeonly{tcolorbox.doc.poster}
...
% after the appendix
%\includeonly{tcolorbox.doc.picturecredits,tcolorbox.doc.references,tcolorbox.doc.index}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\shorthandoff{:}     % french option of babel change catcode of colon ':'
